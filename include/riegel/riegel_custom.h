...
enum {
    RIEGEL_REG_DSKDATR = 0x008,
    RIEGEL_REG_ADKCONR = 0x010,
    RIEGEL_REG_DSKBYTR = 0x01a,
    RIEGEL_REG_DSKPTH = 0x020,
    RIEGEL_REG_DSKPTL = 0x022,
    RIEGEL_REG_DSKLEN = 0x024,
    RIEGEL_REG_DMACON = 0x096,
    RIEGEL_REG_INTENA = 0x09a,
    RIEGEL_REG_ADKCON = 0x09e,
    RIEGEL_REG_INTREQ = 0x09c,
    RIEGEL_REG_DSKSYNC = 0x07e,
