...
- slot scheduler next gains: disk `_step_slot()`, audio `_step_slot()`, sprite DMA `_step_slot()`; bitplane fetch at DDFSTRT-derived range (currently fixed approximation from AGNUS_HPOS_BITPLANE_START)
